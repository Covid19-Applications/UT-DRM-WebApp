...
form #logout{
 ...
 <div class="main-content" style="background-color: #808080;" >
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            <div class="icon">
                                            <img src="img/uttrakhand/virus.png" style="height: 50px;">
                                            </div>
                                            <div class="text">
                                ...
                                <div class="overview-item overview-item--c5">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Uttarakhand Confirmed Cases</span>
                                ...
                                <div class="overview-item overview-item--recovered">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Uttarakhand Recovered Cases</span>
                                ...
                                <div class="overview-item overview-item--death">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <span style="font-size: 17px;">Uttarakhand Death Cases</span>
                                                <h2 id="StateDeath"></h2>
                                            </div>
                                            <div class="progress">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Cases In Uttarakhand</h2>
                            ...
                            <div class="col-lg-3">
                               ...
                               <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Covid19 Test Cases In Uttarakhand</h2>
                                <div class="table-responsive table--no-card m-b-40">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-6">
                                     <div class="au-card chart-percent-card" style="height: 400px;">
                                      ...
                                      <div class="au-card chart-percent-card" style="height: 580px;" id="testing">
                                        <div class="au-card-inner">
                                            <h3 class="title-2 tm-b-5">
                                            ...
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-lg-12">
                                                    <iframe src="https://www.google.co.in/maps/d/embed?mid=1Mzd23_q7QlP3yE3CSIk0julUULcGKz2G" width="100%" height="380"></iframe>
                                                </div>
                                            </div>    
                                        </div>    
                                     </div>
...
$.ajax({
    ...
    var conf_rate = (((StateConfirmed)*100)/(3280225));
